            ...
            <div className="bg-white shadow-md rounded-md p-6">
              ...
              <form className="space-y-6" method="POST" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <h2 className='text-center my-2'>If You Have Already Account Please <span className='hover:text-red-500 underline text-blue-500'> <Link to="/admin-login">Login</Link> </span></h2>
                  {alResData == "" ? null : (
