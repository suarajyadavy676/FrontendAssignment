...
function InstructorLogin() {
  ...
  return (
    <div>
      <div className="">
        <div className="max-w-xl py-6 px-8 h-96 mt-20 bg-white rounded shadow-xl mx-auto">
        <h1 className="text-center text-bold text-xl mb-5">Instructor Login Page</h1>
